<h4 align="center">
  <img src="../Assets/Minim Goal Bar Widget - Banner.png" alt="Minim Goal Bar">
</h4>
...
1. Go to the scene you wish to add the alerts to. Add a new source and select <kbd><b>Scene</b></kbd><br>
    ...
    <img src="../Assets/Minim Goal Bar Widget - OBS Add Scene 1.png" alt="add scene screenshot"><br>

1. Select <kbd><b>Add Existing</b></kbd> and choose <kbd><b>StreamUP Widgets • Minim Goal Bar</b></kbd> then press <kbd><b>OK</b></kbd><br>

    <img src="../Assets/Minim Goal Bar Widget - OBS Add Scene 2.png" alt="add scene part 2 screenshot"><br>

1. Adjust the size and positioning of the alerts then lock the source<br>

    <img src="../Assets/Minim Goal Bar Widget - Position In OBS.png" alt="positioning scene in obs screenshot">
...
1. Select the <kbd><b>Actions</b></kbd> tab. Under the <kbd><b>Actions</b></kbd> window on the left select <kbd><b>Minim Goal Bar • Settings</b></kbd><br>
Under the <kbd><b>Triggers</b></kbd> window on the left, right click the top trigger and press <kbd><b>Test Trigger</b></kbd><br>

   <img src="../Assets/Minim Goal Bar Widget - Open Settings.png" alt="Minim Goal Bar StreamerBot open settings page"><br>
...
Press <kbd><b>Save</b></kbd> at the bottom of the window<br>
    ...
    <img src="../Assets/Minim Goal Bar Widget - Settings 1.png" alt="Minim Goal Bar Widget settings page 1">
    <img src="../Assets/Minim Goal Bar Widget - Settings 2.png" alt="Minim Goal Bar Widget settings page 2">

3. By default this widget will start rotating through your goal when OBS starts streaming. You can create your own trigger if you like by heading to the <kbd><b>Actions</b></kbd> tab and select <kbd><b>Minim Goal Bar • Main Action</b></kbd><br>
In the <kbd><b>Triggers</b></kbd> window on the right side, right click in and create a new one

      <img src="../Assets/Minim Goal Bar Widget - Main Action.png" alt="Minim Goal Bar Widget test action in streamerbot"><br>
