<h4 align="center">
  <img src="../Assets/Minim Alerts - Banner.png" alt="minim alerts">
</h4>
...
1. Go to the scene you wish to add the alerts to. Add a new source and select <kbd><b>Scene</b></kbd><br>
    ...
    <img src="../Assets/Minim Alerts - OBS Add Scene 1.png" alt="add scene screenshot"><br>

1. Select <kbd><b>Add Existing</b></kbd> and choose <kbd><b>StreamUP Alerts • Minim</b></kbd> then press <kbd><b>OK</b></kbd><br>

    <img src="../Assets/Minim Alerts - OBS Add Scene 2.png" alt="add scene part 2 screenshot"><br>

1. Adjust the size and positioning of the alerts then lock the source<br>

    <img src="../Assets/Minim Alerts - Position In OBS.png" alt="positioning scene in obs screenshot">
...
Press <kbd><b>Save</b></kbd> at the bottom of the window<br>
    ...
    <img src="../Assets/Minim Alerts - Settings 1.png" alt="Minim alerts settings page 1">
    <img src="../Assets/Minim Alerts - Settings 2.png" alt="Minim alerts settings page 2"><br>

3. To test everything is working okay, head to the <kbd><b>Actions</b></kbd> tab and select <kbd><b>Minim Alerts • Main Action</b></kbd><br>
In the <kbd><b>Triggers</b></kbd> window on the right side, right click a trigger and press <kbd><b>Test</b></kbd>, check OBS to see the alerts in action<br>
    ...
    <img src="../Assets/Minim Alerts - Test Main Action.png" alt="Minim alerts test action in streamerbot"><br>
