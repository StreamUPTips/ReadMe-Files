<h4 align="center">
  <img src="../Assets/Minim Poll Widget - Banner.png" alt="Minim Poll">
</h4>
...
1. Go to the scene you wish to add the alerts to. Add a new source and select <kbd><b>Scene</b></kbd><br>
    ...
    <img src="../Assets/Minim Poll Widget - OBS Add Scene 1.png" alt="add scene screenshot"><br>

1. Select <kbd><b>Add Existing</b></kbd> and choose <kbd><b>StreamUP Widgets • Minim Poll</b></kbd> then press <kbd><b>OK</b></kbd><br>

    <img src="../Assets/Minim Poll Widget - OBS Add Scene 2.png" alt="add scene part 2 screenshot"><br>

1. Adjust the size and positioning of the alerts then lock the source<br>

    <img src="../Assets/Minim Poll Widget - Position In OBS.png" alt="positioning scene in obs screenshot">
...
1. Select the <kbd><b>Actions</b></kbd> tab. Under the <kbd><b>Actions</b></kbd> window on the left select <kbd><b>Minim Poll • Settings</b></kbd><br>
Under the <kbd><b>Triggers</b></kbd> window on the right, right click the top trigger and press <kbd><b>Test Trigger</b></kbd><br>

   <img src="../Assets/Minim Poll Widget - Open Settings.png" alt="Minim Poll StreamerBot open settings page"><br>
...
Press <kbd><b>Save</b></kbd> at the bottom of the window<br>
    ...
    <img src="../Assets/Minim Poll Widget - Settings 1.png" alt="Minim Poll Widget settings page 1">

3.  Go to the <kbd><b>Actions</b></kbd> tab and select <kbd><b>Minim Poll • Main Action</b></kbd><br>
In the <kbd><b>Triggers</b></kbd> window on the right side, right click <kbd><b>Poll Terminated</b></kbd> and press <kbd><b>Test Trigger</b></kbd>. The next time you create a poll on Twitch the widget will appear in OBS.

      <img src="../Assets/Minim Poll Widget - Test Main Action.png" alt="Minim Poll Widget test action in streamerbot"><br>
